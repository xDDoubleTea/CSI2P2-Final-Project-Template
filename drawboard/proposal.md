...
- 傷害計算
  ...
  - Spins
    ...
    - **新增（與上學期不同）**All spin可以延續Back-to-Back
      - 只要任何方塊在消排之前的最後一次操作是旋轉，且方塊最終位置沒有辦法左右移動，則判定為All spin
      - 詳情：[List of twists - Hard Drop Tetris Wiki](https://harddrop.com/wiki/List_of_twists)
...
Sound effects are from [TETR.IO](https://tetr.io/).
